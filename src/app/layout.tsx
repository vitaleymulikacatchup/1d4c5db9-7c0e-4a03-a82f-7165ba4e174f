...
export const metadata: Metadata = {
  title: "StyleHub - Premium Clothing Store | Fashion Forward Pieces",
  description: "Discover StyleHub's curated collection of premium clothing for every occasion. Quality, sustainable fashion that helps you express your unique style.",
  keywords: "clothing store, premium fashion, women's clothing, men's clothing, sustainable fashion, online shopping",
  ...
  openGraph: {
    ...
    description: "Discover StyleHub's curated collection of premium clothing for every occasion.",
    url: "https://stylehub.com",
    siteName: "StyleHub",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765379338257-tuxxejce.jpg",
      alt: "StyleHub featured collection"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "StyleHub - Premium Clothing Store",
    description: "Discover premium clothing that expresses your unique style.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765379338257-tuxxejce.jpg"]
  },
  robots: {
    index: true,
    follow: true
